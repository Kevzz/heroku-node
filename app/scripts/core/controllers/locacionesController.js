angular.module('theme.core.main_controller', ['theme.core.services'], ['firebase'])
  .controller('locacionesController', ['$scope', '$theme', '$timeout', 'progressLoader', 'wijetsService', '$location',
